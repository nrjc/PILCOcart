...
\begin{par}
\textbf{Summary:} Implements ths ODE for simulating the double pendulum dynamics, where an input torque can be applied to both links, f(1):torque at inner joint, f(2):torque at outer joint
\end{par} \vspace{1em}
