% Compute moments of the 5th order Fourier series fit to a sigmoid
...
% Edited by Rowan 2015-07-22

function [M, S, C, dMdm, dSdm, dCdm, dMdv, dSdv, dCdv] = gSat5(m, v, i, e)
...
d = length(m); I = length(i); i = i(:)'; f = [1; 3; 5]/2.1639; F = length(f); 
...
[M2, S2, C2, Mdma, Sdma, Cdma, Mdva, Sdva, Cdva] ...
                           = gSin(ma, va, d+1:d+F*I, e*[1.1895 0.2403 0.0507]);
