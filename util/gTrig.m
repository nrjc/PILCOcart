...
% x sim N(m,v) and i is a (possibly empty) set of I indices. The optional e
% scaling factor is a vector of length I. Optionally, compute derivatives of
% the moments.
%
% Copyright (C) 2012 by Carl Edward Rasmussen, 2012-06-01
...
% dMdv  derivatives of M w.r.t v                                    [ 2I x dd ]
% dVdv  derivatives of V w.r.t v                                    [4II x dd ]
% dCdv  derivatives of C w.r.t v                                    [2dI x dd ]
