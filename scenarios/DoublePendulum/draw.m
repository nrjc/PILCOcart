function draw(theta1, theta2, f1, f2, cost, s, s2, M, S)
% Draws the double pendulum system
%
...
reward = 1-loss(cost,[0, 0, theta1, theta2]',zeros(4));
plot([0 reward*xmax],[-0.7, -0.7],'y','linewidth',10)
text(0,-0.3,'applied  torque (1st joint)')
text(0,-0.5,'applied  torque (2nd joint)')
